...
<header class="header">
   <figure>
       <img src="/aularafael/projetophp/icatalogo-parte/icatalogo-parte1/imgs/logo.png">
   </figure>
        ...
        <h1>Fazer login</h1>
        <form  method="POST" action="/aularafael/projetophp/icatalogo-parte/icatalogo-parte1/componentes/header/acoesLogin.php">
